            ...
            <div className={styles.contentWrapper}>
                ...
                <div className={styles.content}>
                    <div className={styles.textWrapper}>
                        ...
                        <p>Финансовые нарушения, защита персональных данных, защита личных цифровых ресурсов,
                            правила
                            работы
                            в сети интернет</p>
                    </div>
                ...
                <div className={styles.content}>
                    <div className={styles.textWrapper}>
                        ...
                        <p>Игровой подход с интерактивными заданиями и напоминания от нашего талисмана - енота
                            Джерри
